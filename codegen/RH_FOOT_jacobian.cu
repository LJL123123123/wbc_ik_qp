...
__global__ void evaluate_kernel (
    ...
    int env_idx = idx * n_w;
    if (idx < batch_size) {
        work[env_idx + 0] = inputs[0][idx * nnz_in[0] + 17];
        work[env_idx + 1] = cos(work[env_idx + 0]);
        work[env_idx + 2] = inputs[0][idx * nnz_in[0] + 18];
        ...
        work[env_idx + 7] = inputs[0][idx * nnz_in[0] + 16];
        ...
        outputs[0][idx * nnz_out[0] + 36] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 37] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 38] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 39] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 40] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 41] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 42] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 43] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 44] = work[env_idx + 5];
        ...
        outputs[0][idx * nnz_out[0] + 48] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 49] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 50] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 51] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 52] = work[env_idx + 5];
        ...
        outputs[0][idx * nnz_out[0] + 90] = work[env_idx + 9];
        work[env_idx + 21] = -work[env_idx + 21];
        outputs[0][idx * nnz_out[0] + 91] = work[env_idx + 21];
        work[env_idx + 17] = work[env_idx + 17] * work[env_idx + 11];
        outputs[0][idx * nnz_out[0] + 92] = work[env_idx + 17];
        outputs[0][idx * nnz_out[0] + 93] = work[env_idx + 4];
        outputs[0][idx * nnz_out[0] + 94] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 95] = work[env_idx + 6];
        ...
        outputs[0][idx * nnz_out[0] + 96] = work[env_idx + 6];
