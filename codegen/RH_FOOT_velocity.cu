...
__global__ void evaluate_kernel (
    ...
    if (idx < batch_size) {
        ...
        work[env_idx + 7] = inputs[0][idx * nnz_in[0] + 17];
        ...
        work[env_idx + 15] = inputs[0][idx * nnz_in[0] + 16];
        ...
        work[env_idx + 20] = inputs[0][idx * nnz_in[0] + 18];
        ...
        work[env_idx + 36] = inputs[1][idx * nnz_in[1] + 15];
        ...
        work[env_idx + 39] = inputs[1][idx * nnz_in[1] + 16];
        ...
        work[env_idx + 0] = inputs[1][idx * nnz_in[1] + 17];
