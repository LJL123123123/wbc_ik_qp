...
__global__ void evaluate_kernel (
    ...
    if (idx < batch_size) {
        ...
        work[env_idx + 7] = inputs[0][idx * nnz_in[0] + 11];
        ...
        work[env_idx + 15] = inputs[0][idx * nnz_in[0] + 10];
        ...
        work[env_idx + 20] = inputs[0][idx * nnz_in[0] + 12];
        ...
        work[env_idx + 36] = inputs[1][idx * nnz_in[1] + 9];
        ...
        work[env_idx + 39] = inputs[1][idx * nnz_in[1] + 10];
        ...
        work[env_idx + 0] = inputs[1][idx * nnz_in[1] + 11];
