...
__global__ void evaluate_kernel (
    ...
    int env_idx = idx * n_w;
    if (idx < batch_size) {
        work[env_idx + 0] = inputs[0][idx * nnz_in[0] + 11];
        work[env_idx + 1] = cos(work[env_idx + 0]);
        work[env_idx + 2] = inputs[0][idx * nnz_in[0] + 12];
        ...
        outputs[0][idx * nnz_out[0] + 54] = work[env_idx + 9];
        work[env_idx + 21] = -work[env_idx + 21];
        outputs[0][idx * nnz_out[0] + 55] = work[env_idx + 21];
        work[env_idx + 17] = work[env_idx + 17] * work[env_idx + 11];
        outputs[0][idx * nnz_out[0] + 56] = work[env_idx + 17];
        outputs[0][idx * nnz_out[0] + 57] = work[env_idx + 4];
        outputs[0][idx * nnz_out[0] + 58] = work[env_idx + 5];
        outputs[0][idx * nnz_out[0] + 59] = work[env_idx + 6];
        ...
        outputs[0][idx * nnz_out[0] + 60] = work[env_idx + 6];
